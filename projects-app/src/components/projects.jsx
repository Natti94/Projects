      ...
      <div className="profile-preview-container">
        ...
        <p className="profile-introduction">
          ...
          <p>
            ...
            performance and user interface. I hope to achieve this by
            implementing various enhancements and features that will make the
            game more enjoyable for players and later partner up with other
            developers to expand the project. <br />
            <br />
